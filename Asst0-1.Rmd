...
---
**Due Wednesday, January 25 @ 11:59pm through Github**
...
* **Preferred name:** Dr. Taub and Dr. Jager
* **Pronunciation of your name:** Towwwb and JAY-ger
* **Pronouns (if you want to share, otherwise just leave blank):** she/her/hers and she/her/hers
* **What is your previous experience with R?**  We have both been using R to analyze data for almost 20 years, but are learning new things about it all the time.  Dr. Taub co-organizes the local R Ladies Baltimore chapter. Dr. Jager likes to follow the #rstats hashtag on twitter to see all the cool things people are able to do with R these days that weren't possible back when I started with it.
...
* **Anything else you would like us to know?** We are looking forward to working with you this semester and are eager to support your learning in any way we can. If you have questions or concerns at any point in the semester, please let us know so we can help.  If you have a particular concern as we start the semester, you can list it here or reach out over email.  We're happy to schedule a time to talk with you individually or over Zoom as well.
