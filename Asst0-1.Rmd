...
---
**Due Monday, January 25 @ 11:59pm through Github**
...
* **Anything else you would like us to know?** We are looking forward to working with you this semester.  But we also know there will be challenges this semester due to current events and the (mostly) online learning situation this spring.  If you have questions or concerns at any point in the semester, please let us know so we can help.  If you have a particular concern as we start the semester, you can list it here or reach out over email.  We're happy to schedule a time to talk over Zoom as well.
...
* In the window that opens, **stage** your changes by clicking the check boxes next to the `Asst0-1.Rmd` and `Asst0-1.html` files.
